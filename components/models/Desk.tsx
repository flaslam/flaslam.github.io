...
export default function Model({ ...props }: JSX.IntrinsicElements["group"]) {
  ...
  const texture = useLoader(THREE.TextureLoader, "/models/ACPalette.png");

  const newMat = new THREE.MeshToonMaterial({ map: texture });

  const { nodes, materials } = useGLTF(
    "/models/Desk3.0-transformed.glb"
  ) as GLTFResult;

  materials.Main.map = texture;
  materials.MainEmit.map = texture;
  ...
  return (
    <group ref={group} {...props} dispose={null} castShadow receiveShadow>
      <mesh
        ...
        receiveShadow
      />
      <group position={[0, 0.7, -1.26]} receiveShadow>
        <mesh
      ...
      >
        <mesh geometry={nodes.Cube035.geometry} material={materials.Main} />
        <mesh
      ...
      <group
        ...
        scale={0.1}
      >
        <mesh geometry={nodes.Cube048.geometry} material={materials.Main} />
        <mesh
      ...
      >
        <mesh geometry={nodes.Cube036.geometry} material={materials.Main} />
        <mesh
...
useGLTF.preload("/Desk3.0-transformed.glb");
